...
interface HeroSectionProps {
  language: 'ko' | 'en'; // kept for compat
}
  ...
  return (
    <section className="w-full bg-[#F4FAFF] pt-[100px] pb-24 text-center font-sans tracking-tight">
      <div className="max-w-[1280px] mx-auto px-4 flex flex-col items-center">
        ...
        <p className="text-[#555] text-lg md:text-[22px] font-bold leading-[1.6] tracking-[-0.03em] whitespace-pre-wrap keep-all">{t('hero_desc')}</p>
      </div>
    </section>
  );
};
