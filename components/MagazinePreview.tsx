      ...
      <div className="flex items-center justify-between mb-8 px-2">
        <div>
          <div className="flex items-center gap-2 mb-1">
            ...
            <h2 className="text-[20px] font-black text-[#111]">
      ...
      <div className="flex gap-5 overflow-x-auto no-scrollbar px-2 pb-4 snap-x snap-mandatory">
        {posts.map((post, idx) => (
          ...
          >
            ...
            <h3 className="text-[15px] font-bold text-[#111] leading-snug mb-1.5 line-clamp-2 group-hover:text-[#0070F0] transition-colors">
              {post.title}
            </h3>
