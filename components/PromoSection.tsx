...
export const PromoSection: React.FC<PromoSectionProps> = ({ onGroupBuyClick, language }) => {
  ...
  return (
    <section className="w-full font-sans tracking-tight relative overflow-hidden py-1">
        {/* Premium Background: Deep Crimson Gradient with Mesh Effect */}
                ...
                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-12">
                    ...
                    <div className="flex-1 max-w-2xl relative z-10">
                        ...
                        <div className="flex flex-wrap gap-3">
                            <div className="bg-white/10 backdrop-blur-md border border-white/20 px-5 py-2.5 rounded-2xl flex items-center gap-2.5 shadow-sm">
                                ...
                                <span className="text-white text-[13px] font-bold">최대 30% 할인 혜택</span>
                            </div>
                            <div className="bg-white/10 backdrop-blur-md border border-white/20 px-5 py-2.5 rounded-2xl flex items-center gap-2.5 shadow-sm">
                                <Users size={18} className="text-yellow-400" />
                                <span className="text-white text-[13px] font-bold">전 세계 인원 매칭</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="relative group lg:mr-4 z-50">
                        ...
                        <div className="relative bg-white p-10 md:p-12 rounded-[36px] shadow-2xl flex flex-col items-center text-center min-w-[300px] md:min-w-[380px] transform transition-all duration-500 hover:-translate-y-3 border border-white/50">
                            <div className="w-20 h-20 bg-[#D32F2F]/5 rounded-3xl flex items-center justify-center text-[#D32F2F] mb-8 shadow-inner rotate-3 group-hover:rotate-0 transition-transform pointer-events-none">
                                <Flame size={40} className="fill-[#D32F2F]" />
                            </div>
                            
                            <div className="mb-10 pointer-events-none">
                                <p className="text-[#D32F2F] text-[14px] font-black uppercase tracking-widest mb-2 italic">Join the Movement</p>
                                <p className="text-gray-400 text-xs font-bold uppercase tracking-tight">
                                    {language === 'ko' ? '인기 공동구매 12개 실시간 진행 중' : '12 HOT DEALS ARE LIVE NOW'}
                                </p>
                            </div>
