  ...
  return (
    <div className="w-full bg-white relative font-sans tracking-tight text-[#111] overflow-x-hidden">
      ...
      {!mobileBookingOpen && !paymentSuccess && (
        <div className="lg:hidden fixed left-0 right-0 bg-white border-t border-gray-200 px-4 py-3 z-50 shadow-[0_-4px_20px_rgba(0,0,0,0.08)] bottom-[80px] md:bottom-0">
