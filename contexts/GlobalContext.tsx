...
const TRANSLATIONS: any = {
  ko: {
    ...
    step3: 'STEP 3', select_option: '옵션을 선택해주세요',
    ...
    enter_name_messenger: '이름과 메신저 ID를 입력해주세요.',
    no_faqs: '등록된 FAQ가 없습니다.', no_locations: '등록된 방문지 정보가 없습니다.',
    review_count: '개 리뷰',
    paypal_loading: 'PayPal 결제 준비 중...', paypal_load_error: 'PayPal을 불러올 수 없습니다.',
    paypal_init_error: 'PayPal 초기화 오류', retry: '다시 시도',
    my_reservations: '예약 내역', my_profile: '내 정보',
    no_reservations: '예약 내역이 없습니다.', my_group_buys: '참여 공동구매 현황',
    no_group_buys: '참여한 공동구매가 없습니다.',
    status_closed: '마감', status_active: '진행중',
    recruitment_status: '모집 현황', people_unit: '명',
    original_price: '정가', discounted_price: '할인가', discount_rate: '할인율',
    visit_date: '방문 예정일',
    cancel_3day_limit: '방문 3일 이내 취소 불가', cancel_participation: '참여 취소',
    cancel_3day_alert: '방문 예정일 3일 이내에는 참여를 취소할 수 없습니다.',
    cancel_success: '참여가 취소되었습니다. 예약금은 영업일 기준 3~5일 이내 환불됩니다.',
    cancel_error: '취소 처리 중 오류가 발생했습니다.',
    cancel_confirm: '정말 참여를 취소하시겠습니까? 예약금은 영업일 기준 3~5일 이내 환불됩니다.',
    profile_updated: '프로필이 업데이트되었습니다.',
    inquiry_submitted: '문의가 접수되었습니다.',
    enter_title_placeholder: '제목을 입력하세요',
    inquiry_detail_placeholder: '문의 내용을 자세히 적어주세요. (비공개 처리됩니다)',
    submit_inquiry: '접수하기', no_inquiries: '접수된 문의가 없습니다.',
    admin_label: '관리자',
    add_selected_cart: '선택 장바구니 담기',
    wishlist_empty: '위시리스트가 비어있습니다.', cart_empty: '장바구니가 비어있습니다.',
    shopping_cart: '장바구니', selected_total: '선택 합계', items_unit: '개',
    total_items: '총 상품', select_items_to_pay: '결제할 상품을 선택해주세요',
    individual_payment_note: '각 상품의 상세 페이지에서 개별 결제가 진행됩니다.',
    status_confirmed_label: '예약확정', status_cancelled_label: '취소됨', status_pending_label: '예약대기',
    gb_max_discount: '최대 30% 할인', gb_success_count: '10명 모집 시 성공!',
    max_discount_label: '최대 할인율', deposit_label: '예약금',
    login_required: '로그인이 필요합니다.',
    already_joined: '이미 참여중인 공동구매입니다.',
    joined_success: '참여가 완료되었습니다!',
    login_to_create: '공동구매를 생성하려면 로그인이 필요합니다.',
    fill_participant: '참여자 {n}의 정보를 모두 입력해주세요.',
    group_created: '공동구매가 생성되었습니다!',
    active_groups: '진행중인 공동구매', finished_groups: '마감된 공동구매',
    no_finished: '마감된 내역이 없습니다', no_active_groups: '진행 중인 공동구매가 없습니다',
    active_coming_soon: '곧 새로운 공동구매가 열릴 예정입니다. 함께하면 최대 30% 할인!',
    finished_check_later: '완료된 공동구매 내역이 이곳에 표시됩니다.',
    join_confirm: '공동구매에 참여하시겠습니까?\n예약금 결제:',
    select_product_date: '상품과 날짜를 선택해주세요.'
  },
  en: {
    ...
    step3: 'STEP 3', select_option: 'Please select an option',
    ...
    enter_name_messenger: 'Please enter name and messenger ID.',
    no_faqs: 'No FAQs available.', no_locations: 'No location information available.',
    review_count: ' reviews',
    paypal_loading: 'Loading PayPal...', paypal_load_error: 'Could not load PayPal.',
    paypal_init_error: 'PayPal initialization error', retry: 'Retry',
    my_reservations: 'Reservations', my_profile: 'My Profile',
    no_reservations: 'No Reservations.', my_group_buys: 'My Group Buys',
    no_group_buys: 'No group buys joined.',
    status_closed: 'Closed', status_active: 'Active',
    recruitment_status: 'Progress', people_unit: '',
    original_price: 'Original', discounted_price: 'Discounted', discount_rate: 'Discount',
    visit_date: 'Visit Date',
    cancel_3day_limit: 'Cannot cancel within 3 days', cancel_participation: 'Cancel',
    cancel_3day_alert: 'Cannot cancel within 3 days of the visit date.',
    cancel_success: 'Cancelled. Deposit will be refunded within 3-5 business days.',
    cancel_error: 'Error cancelling participation.',
    cancel_confirm: 'Are you sure you want to cancel? Deposit will be refunded within 3-5 business days.',
    profile_updated: 'Profile updated.',
    inquiry_submitted: 'Inquiry submitted.',
    enter_title_placeholder: 'Enter title',
    inquiry_detail_placeholder: 'Please describe your inquiry in detail. (Private)',
    submit_inquiry: 'Submit', no_inquiries: 'No inquiries yet.',
    admin_label: 'Admin',
    add_selected_cart: 'Add to Cart',
    wishlist_empty: 'Your wishlist is empty.', cart_empty: 'Your cart is empty.',
    shopping_cart: 'Shopping Cart', selected_total: 'Selected Total', items_unit: ' items',
    total_items: 'Total Items', select_items_to_pay: 'Select items to proceed to payment',
    individual_payment_note: 'Each item will be processed individually from its detail page.',
    status_confirmed_label: 'Confirmed', status_cancelled_label: 'Cancelled', status_pending_label: 'Pending',
    gb_max_discount: 'Up to 30% off', gb_success_count: '10 people = Success!',
    max_discount_label: 'Max Discount', deposit_label: 'Deposit',
    login_required: 'Please login first.',
    already_joined: 'You already joined.',
    joined_success: 'Joined successfully!',
    login_to_create: 'Please login to create a group.',
    fill_participant: 'Please fill in all details for Participant {n}',
    group_created: 'Group Created!',
    active_groups: 'Active Groups', finished_groups: 'Finished',
    no_finished: 'No Finished Groups', no_active_groups: 'No Active Groups',
    active_coming_soon: 'New group buys will be posted here soon. Stay tuned for great deals!',
    finished_check_later: 'Check back later for finished events.',
    join_confirm: 'Join this group?\nDeposit:',
    select_product_date: 'Please select a product and date.'
  },
  ja: {
    ...
    step3: 'STEP 3', select_option: 'オプションを選択してください',
    ...
    enter_name_messenger: '名前とメッセンジャーIDを入力してください。',
    no_faqs: 'FAQはまだありません。', no_locations: '訪問先情報はありません。',
    review_count: '件のレビュー',
    paypal_loading: 'PayPal読み込み中...', paypal_load_error: 'PayPalを読み込めません。',
    paypal_init_error: 'PayPal初期化エラー', retry: '再試行',
    my_reservations: '予約履歴', my_profile: 'マイプロフィール',
    no_reservations: '予約履歴はありません。', my_group_buys: '参加中の共同購入',
    no_group_buys: '参加中の共同購入はありません。',
    status_closed: '終了', status_active: '進行中',
    recruitment_status: '募集状況', people_unit: '名',
    original_price: '定価', discounted_price: '割引価格', discount_rate: '割引率',
    visit_date: '訪問予定日',
    cancel_3day_limit: '3日以内のキャンセル不可', cancel_participation: '参加取消',
    cancel_3day_alert: '訪問予定日の3日以内はキャンセルできません。',
    cancel_success: '参加がキャンセルされました。予約金は3〜5営業日以内に返金されます。',
    cancel_error: 'キャンセル処理中にエラーが発生しました。',
    cancel_confirm: '本当にキャンセルしますか？予約金は3〜5営業日以内に返金されます。',
    profile_updated: 'プロフィールが更新されました。',
    inquiry_submitted: 'お問い合わせが送信されました。',
    enter_title_placeholder: 'タイトルを入力してください',
    inquiry_detail_placeholder: 'お問い合わせ内容を詳しくご記入ください。（非公開）',
    submit_inquiry: '送信する', no_inquiries: 'お問い合わせはまだありません。',
    admin_label: '管理者',
    add_selected_cart: 'カートに追加',
    wishlist_empty: 'お気に入りは空です。', cart_empty: 'カートは空です。',
    shopping_cart: 'ショッピングカート', selected_total: '選択合計', items_unit: '個',
    total_items: '合計商品', select_items_to_pay: 'お支払い商品を選択してください',
    individual_payment_note: '各商品の詳細ページから個別にお支払いが行われます。',
    status_confirmed_label: '予約確定', status_cancelled_label: 'キャンセル', status_pending_label: '予約待ち',
    gb_max_discount: '最大30%割引', gb_success_count: '10人で成立！',
    max_discount_label: '最大割引率', deposit_label: '予約金',
    login_required: 'ログインが必要です。',
    already_joined: 'すでに参加中の共同購入です。',
    joined_success: '参加が完了しました！',
    login_to_create: '共同購入を作成するにはログインが必要です。',
    fill_participant: '参加者{n}の情報をすべて入力してください。',
    group_created: '共同購入が作成されました！',
    active_groups: '進行中の共同購入', finished_groups: '終了した共同購入',
    no_finished: '終了した共同購入はありません', no_active_groups: '進行中の共同購入はありません',
    active_coming_soon: '近日中に新しい共同購入が開始されます。一緒に最大30%割引！',
    finished_check_later: '完了した共同購入の履歴がここに表示されます。',
    join_confirm: '共同購入に参加しますか？\n予約金:',
    select_product_date: '商品と日付を選択してください。'
  },
  zh: {
    ...
    step3: 'STEP 3', select_option: '请选择选项',
    ...
    enter_name_messenger: '请输入姓名和通讯软件ID。',
    no_faqs: '暂无FAQ。', no_locations: '暂无访问地点信息。',
    review_count: '条评价',
    paypal_loading: 'PayPal加载中...', paypal_load_error: '无法加载PayPal。',
    paypal_init_error: 'PayPal初始化错误', retry: '重试',
    my_reservations: '预约记录', my_profile: '我的信息',
    no_reservations: '暂无预约记录。', my_group_buys: '参与的拼团',
    no_group_buys: '暂未参与拼团。',
    status_closed: '已结束', status_active: '进行中',
    recruitment_status: '招募进度', people_unit: '人',
    original_price: '原价', discounted_price: '折扣价', discount_rate: '折扣率',
    visit_date: '预计到访日期',
    cancel_3day_limit: '3天内不可取消', cancel_participation: '取消参与',
    cancel_3day_alert: '距离预计到访日3天内无法取消参与。',
    cancel_success: '已取消参与。定金将在3-5个工作日内退还。',
    cancel_error: '取消处理出错。',
    cancel_confirm: '确定要取消参与吗？定金将在3-5个工作日内退还。',
    profile_updated: '资料已更新。',
    inquiry_submitted: '咨询已提交。',
    enter_title_placeholder: '请输入标题',
    inquiry_detail_placeholder: '请详细描述您的咨询内容。（不公开）',
    submit_inquiry: '提交', no_inquiries: '暂无咨询记录。',
    admin_label: '管理员',
    add_selected_cart: '加入购物车',
    wishlist_empty: '收藏夹为空。', cart_empty: '购物车为空。',
    shopping_cart: '购物车', selected_total: '选中合计', items_unit: '件',
    total_items: '商品合计', select_items_to_pay: '请选择要支付的商品',
    individual_payment_note: '每件商品将在其详情页面单独结算。',
    status_confirmed_label: '已确认', status_cancelled_label: '已取消', status_pending_label: '待确认',
    gb_max_discount: '最高享30%折扣', gb_success_count: '10人成团！',
    max_discount_label: '最高折扣率', deposit_label: '定金',
    login_required: '请先登录。',
    already_joined: '您已参与此拼团。',
    joined_success: '参与成功！',
    login_to_create: '创建拼团需要先登录。',
    fill_participant: '请填写参与者{n}的所有信息。',
    group_created: '拼团已创建！',
    active_groups: '进行中的拼团', finished_groups: '已结束的拼团',
    no_finished: '暂无已结束的拼团', no_active_groups: '暂无进行中的拼团',
    active_coming_soon: '即将开启新的拼团活动。一起拼团最高享30%折扣！',
    finished_check_later: '已完成的拼团记录将在此显示。',
    join_confirm: '加入此拼团？\n定金:',
    select_product_date: '请选择商品和日期。'
  }
};
